...
//! image placement primitives, [`image_viewport::ImageViewport`], the
//! pixel-space image aperture model, and [`grid::Grid`], the reusable
//! local-coordinate grid container extracted from c4tui's view picker.
